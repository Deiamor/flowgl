 ...
 */
export function edgeControlPoints(sx, sy, sourceHandle, ex, ey, targetHandle) {
...
export function cubicBezierPoint(t, p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
...
export function buildBezierStrip(sx, sy, c1x, c1y, c2x, c2y, ex, ey, r, g, b, a, halfWidth, segments = BEZIER_SEGMENTS) {
    const pts = [];
